...
function navSlide() {
  ...
  showSlide(currentSlide);
  updateDots();
  setInterval(showNextSlide, 2000); // Auto-advance every 2 seconds
  ...
  // ---------------- Request Product On Card Click To Display Product Page -------
  ...
  // ---------------- Insert Data into Local Storage  Add To Cart Button -------
